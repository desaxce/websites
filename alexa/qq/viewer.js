...
var ROOT="../"
var CROSSDOMAIN=""
/*var SHUMWAY_ROOT = "http://adnew.qq.com/lab/shumway/src/";
var ROOT="http://adnew.qq.com/lab/shumway/"
var CROSSDOMAIN="http://adnew.qq.com/lab/shumway/crossdomain.php?file="*/
try{
  ROOT=ROOT_OUT;
}catch(e){
...
var viewerPlayerglobalInfo = {
  abcs: ROOT+"build/playerglobal/playerglobal.abcs",
  catalog: ROOT+"build/playerglobal/playerglobal.json"
};
...
function parseSwf(url, movieParams, objectParams, compilerSettings,viewer) {
  ...
  createAVM2(builtinPath, viewerPlayerglobalInfo, avm1Path,
    ...
    function (avm2) {
      //alert("Initialize Renderer");
      SWF.embed(url, document, viewer||document.getElementById("viewer"), {
         url: url,
